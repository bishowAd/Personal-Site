...
export const DATA = {
  ...
  personal: {
    ...
    email: "bishow.adhikari69@gmail.com",
    phone: "(985) 956-9976",
  ...
  /* ── About section ────────────────────────── */
  about: {
    headline: "CS student (Concentration: Data Science)",
    paragraphs: [
  ...
  honors: [
    {
      ...
      desc: "Honors Scholarship (4 semesters) · Dean's List (4 semesters) · SGA Scholarship",
    },
    {
      icon: "🥉",
      bg: "bg-purple-50",
      title: "Integration Bee",
      desc: "2nd Runner-Up, 16th Annual Integration Bee Competition",
    },
    {
      icon: "💻",
      bg: "bg-cyan-50",
      title: "ACM Member",
      desc: "Active member of the Association for Computing Machinery",
    },
    {
      icon: "🌍",
      bg: "bg-emerald-50",
      title: "Student Leadership",
      desc: "International Student Union & Nepalese Student Association member",
    },
    {
      icon: "🤝",
      bg: "bg-yellow-50",
      title: "Community Service",
      desc: "Volunteer for student orientation, campus tours, and university events",
    },
    {
      icon: "📚",
      bg: "bg-pink-50",
      title: "Relevant Coursework",
      desc: "Data Mining · Data Analytics & BI · Data Structures & Algorithms",
    },
  ],
};
